...
struct NativeAdView: UIViewRepresentable {
  ...
  func makeUIView(context: Context) -> GADNativeAdView {
    ...
    func updateUIView(_ nativeAdView: GADNativeAdView, context: Context) {
        ...
        // Set round corner for UIButton
        (nativeAdView.callToActionView as? UIButton)?.layer.cornerRadius = 8
        (nativeAdView.callToActionView as? UIButton)?.clipsToBounds = true
    }
